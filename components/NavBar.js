      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <Box sx={{
            ...
            >
              <Link href='/'> 
                <Box component="img" src="/assets/logo.png" alt="logo" height={26} width={100} />
              </Link>
              <Search>
                <SearchIconWrapper>
                  <SearchIcon />
            ...
            <Box sx={{
              ...
              <Link href={`/loginRegister`}  className={`${pathname === '/loginRegister' ? styles.otherActive : styles.otherLink} `}>
                Log in/Sign Up
              </Link>
